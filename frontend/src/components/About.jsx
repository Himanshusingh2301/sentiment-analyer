  ...
  return (
    <div className="relative min-h-screen bg-cover  bg-center" style={{ backgroundImage: 'url(/bg.png)'  }}>
      <div className="absolute inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center px-4">
        <div className="bg-white/10 border border-white/20 rounded-2xl shadow-xl p-8 max-w-4xl text-white  hover:translate-y-2 ease duration-500">
          <h1 className="text-4xl font-bold mb-6 text-indigo-300">About FeedbackFilter</h1>
